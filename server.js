...
// Helper functions
function addAuditEntry(agentId, event, decision, inputPreview, processingTime) {
  const entry = {
    id: uuid(),
    agentId,
    event,
...
function updateMetrics(agentId, result, processingTimeMs) {
...
app.post('/api/niyanta/chat', async (req, res) => {
