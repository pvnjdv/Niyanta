    ...
    return (
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          <button onClick={() => setShowBuilder(false)} style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: 'var(--text-muted)', background: 'none', border: 'none', cursor: 'pointer' }}>← Workflows</button>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            {[
              ...
              <button key={i} style={{
                ...
                background: btn.primary ? 'var(--accent-dim)' : 'transparent',
                border: btn.primary ? '1px solid var(--accent-border)' : '1px solid var(--border)',
                color: btn.primary ? 'var(--accent)' : 'var(--text-secondary)',
                cursor: 'pointer',
              }}>{btn.label}</button>
            ))}
          </div>
